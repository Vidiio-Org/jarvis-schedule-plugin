    ...
    tbody.replaceChildren(
      ...list.map((s) => {
        ...
        return h(
          ...
          h(
            'td',
            { 'data-label': 'Nome', class: 'cell-name' },
            h('span', {}, h('span', { class: 'cell-title' }, s.name)),
          ),
          h('td', { 'data-label': 'Workspace', class: 'cell-ws' }, s.workspaceName ?? s.workspaceId),
          ...
          h('td', { 'data-label': 'Próxima execução' }, s.enabled ? fmtDate(s.nextRunAt) : '—'),
          h('td', { 'data-label': 'Última execução' }, fmtDate(s.lastRunAt)),
          h(
            'td',
            { class: 'actions' },
            h(
      ...
      tbody.replaceChildren(
        ...runs.map((r) =>
          h(
            'tr',
            { 'data-run-id': r.id },
            h('td', { 'data-label': 'Agendamento', class: 'cell-name' }, h('span', { class: 'cell-title' }, r.scheduleName)),
            h('td', { 'data-label': 'Origem' }, triggerLabel(r.trigger)),
            h('td', { 'data-label': 'Previsto para' }, fmtDate(r.scheduledFor)),
            h('td', { 'data-label': 'Disparado em' }, fmtDate(r.dispatchedAt)),
            h('td', { 'data-label': 'Status' }, runBadge(r.status)),
            h('td', { 'data-label': 'Missão', class: 'cell-ws' }, r.missionName ?? '—'),
